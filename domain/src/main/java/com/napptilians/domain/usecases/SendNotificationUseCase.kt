...
class SendNotificationUseCase @Inject constructor(
    ...
    suspend fun execute(notification: ChatNotificationModel, topic: String): Response<Unit, ErrorModel> =
        withContext(ioDispatcher) { doyRepository.sendNotification(notification, topic) }
}
